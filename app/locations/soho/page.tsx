...
export default function SohoLocation() {
      ...
      <main className="pt-36">
        ...
        <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-6 text-center max-w-3xl">
          <div className="inline-flex items-center gap-1 text-rose-500 font-mono text-xs uppercase tracking-widest font-bold">
            <MapPin className="w-3.5 h-3.5" /> Downtown Manhattan Precinct
          </div>
          <h1 className="text-4xl sm:text-6xl font-display font-light text-white leading-tight">
            The SoHo Collective <br />
            <span className="font-semibold text-rose-500">Luxury Webcam Lofts</span>
          </h1>
          <p className="text-sm text-gray-400 font-sans leading-relaxed">
            Positioned strategic-deep inside Manhattan's most photogenic fashion district. Featuring spacious industrial window-bays, curated contemporary layouts, and full protection shielding under zip codes <span className="text-white font-mono">10012 & 10013</span>.
          </p>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-3xl font-display font-light text-white leading-tight">
              Sovereign Branding and <br />
              <span className="font-semibold text-rose-500">Peak Technology</span>
            </h2>
            <p className="text-sm text-gray-400 leading-relaxed font-sans">
              Our SoHo residency spaces are optimized for premium creators who demand more. We have custom-engineered ultra-fast fiber feeds directly into the building's server lines to ensure absolute zero-buffering broadcast capability.
            </p>
            <div className="space-y-4 font-sans text-sm text-gray-300">
              <div className="flex gap-2">
                <CheckCircle className="w-5 h-5 text-rose-500 flex-shrink-0" />
                <span>Broadcasting under 4K Sony live-capture arrays with full color correction.</span>
              </div>
              <div className="flex gap-2">
                <CheckCircle className="w-5 h-5 text-rose-500 flex-shrink-0" />
                <span>Private dressing zones, custom cosmetic countertops, and heated showers.</span>
              </div>
              <div className="flex gap-2">
                <CheckCircle className="w-5 h-5 text-rose-500 flex-shrink-0" />
                <span>Integrated Facial Search Defense (PIMEyes opt-outs) active from day one.</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative rounded-2xl overflow-hidden border border-rose-500/15 h-80 flex flex-col justify-end p-8 group shadow-2xl bg-neutral-950">
            <div className="absolute inset-0 z-0">
              <Image
                src={sohoModelImg}
                alt="SoHo Studio Live Broadcast Model"
                fill
                placeholder="blur"
            ...
            <div className="relative z-10 space-y-2">
              <span className="text-[10px] font-mono tracking-widest text-rose-500 uppercase font-bold">SoHo Loft Suite Alpha</span>
              <p className="text-xl font-display text-white">Classic Brick & Luxury Velvet Room Layout</p>
              <div className="flex gap-4 text-xs text-gray-400 font-mono">
                <span>Zipcodes: 10012, 10013</span>
                <span>Space: 1,450 sq ft</span>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="glass-panel rounded-2xl p-8 sm:p-10 border-rose-500/10">
              ...
              {submitted ? (
                <div className="text-center space-y-4 py-8">
                  ...
                  <h3 className="text-xl font-semibold text-white">SoHo Session Applied</h3>
                  <p className="text-xs text-gray-400 leading-relaxed">
                    Our downtown operations executive will contact you shortly under strict parameters.
                  </p>
                </div>
              ) : (
                <div className="space-y-6">
                  <div className="text-center">
                    <h3 className="text-xl font-semibold text-white font-display">Reserve SoHo Space</h3>
                    <p className="text-xs text-gray-400 mt-1">Book a tour or apply for a webcam residency setup.</p>
                  </div>
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <input
                      type="text"
                      required
                      placeholder="Your First name / Stage Name *"
                      value={formData.name}
                    ...
                    />
                    <textarea
                      placeholder="Tell us about your scheduling or protection needs (Discreet)"
                      rows={3}
